...
use crate::{ps2::controller::{inb, outb, ps2_read_data, ps2_send_command, ps2_send_data, PS2_DATA, PS2_CMD_DISABLE_SECOND_PORT, PS2_CMD_ENABLE_SECOND_PORT, PS2_CMD_READ_CONFIG, PS2_CMD_TEST_SECOND_PORT, PS2_CMD_WRITE_CONFIG, PS2_CMD_WRITE_TO_SECOND_PORT}, vga::terminal::{Terminal, VGA_HEIGHT, VGA_WIDTH}};
